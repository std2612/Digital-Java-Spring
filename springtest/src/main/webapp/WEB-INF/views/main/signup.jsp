...
<form method="post" action="<%=request.getContextPath()%>/user/signup">
	<div class="container-body">
		...
		<div class="container-pw">
			...
			<div class="box-pw">
				<input type="password" name="pw" id="pw"> <a href="#"></a>
			</div>
		...
		<div class="container-pw">
			...
			<div class="box-pw">
				<input type="password" name="pw2" id="pw2"> <a href="#"></a>
			</div>
		...
		$('input[name=id]').keyup(function() {
			...
			if(id.length >= 4){
				...
				if(id.length == 0){
					...
					$('#id-error').html('아이디는 네글자 이상이어야 합니다.');
				}
			}
		});
		$("form").validate({
			...
			messages : {
				pw : {
					...
					maxlength : "최소 {0}글자 이하이어야 합니다",
					regex : "영문자, 숫자로 이루어져 있으며 최소 하나 이상 포함"
				},
				pw2 : {
					required : "필수로 입력하세요",
